...
| **Routing** | `/login`, `/register`, `/verify-email`, `/forgot-password`, `/forgot-password/verify`, `/reset-password`, `/auth/google/callback`, `/mfa`, `/session-expired`, `/access-denied`, `/account-locked` |
