...
| `docs/product/cv-analysis.md` | CV upload + analysis flow | `BRD/Functional_Requirements.md` FR-004–006, SCR-CAN-021–022 |
...
- US-004 CV analysis upload + result UI (partial/mock).
