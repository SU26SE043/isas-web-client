...
Authenticated candidate completes a **3-step CV analysis wizard** (upload → JD → progress), then views a **match report** with skills, experience, and improvement sections. Selective CV-to-profile mapping with merge strategy.
...
- [x] Step 3 — analysis progress UI with parse error recovery (ERR-021–025 mock).
