...
| Campaign discovery | M04, SCR-CAN-023-025 | Phase 8 UI in progress (`/candidate/campaigns`, mock) |
| Campaign management (B2B) | M04, SCR-EMP-* | Not started |

| Employer onboarding | M04, SCR-EMP-052-054 | Implemented - dashboard, company profile, verification (`/employer/*`; mock) |
