...
Phase 12 implements organization billing UI only:
...
- `/employer/invoices` lists invoices and simulates timestamped PDF generation inside the BRL-024 60-second SLA.
