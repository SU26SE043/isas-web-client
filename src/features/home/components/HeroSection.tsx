      ...
      <div className="w-full px-6 lg:px-20 xl:px-32">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div className="relative">
            <div className="bg-brand-green rounded-[2rem] p-6 shadow-2xl relative overflow-hidden">
              <div className="aspect-video bg-brand-green-dark rounded-xl border border-brand-green-light relative flex items-center justify-center mb-6 overflow-hidden group">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-brand-green/80 via-brand-green/20 to-brand-green/40"></div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 md:w-56 md:h-56 border border-brand-yellow/40 flex flex-col justify-between p-2 z-10 transition-all duration-300 group-hover:border-brand-yellow/80">
                  <div className="flex justify-between">
                    <div className="w-4 h-4 border-t-2 border-l-2 border-brand-yellow"></div>
                    <div className="w-4 h-4 border-t-2 border-r-2 border-brand-yellow"></div>
                  </div>
                  <div className="flex justify-between">
                    <div className="w-4 h-4 border-b-2 border-l-2 border-brand-yellow"></div>
                    <div className="w-4 h-4 border-b-2 border-r-2 border-brand-yellow"></div>
                  </div>
                </div>
