...
export const authTranslations: TranslationDictionary = {
  vi: {
    ...
    'auth.googleCompleting': 'Hoàn tất đăng nhập Google',
    'auth.googleCompletingDescription': 'Hệ thống đang xác minh mã đăng nhập một lần của bạn.',
  ...
  en: {
    ...
    'auth.googleCompletingDescription': 'We are verifying your one-time sign-in code.',
