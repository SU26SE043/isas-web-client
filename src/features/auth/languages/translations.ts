...
export const authTranslations: TranslationDictionary = {
  vi: {
    ...
    'auth.accountBanned': 'Tài khoản đã bị cấm. Vui lòng liên hệ bộ phận hỗ trợ.',
    'auth.forgotPassword': 'Quên mật khẩu?',
    'auth.signUpTitle': 'Tạo tài khoản',
    'auth.fullNamePlaceholder': 'Họ và tên',
    'auth.password': 'Mật khẩu',
    'auth.signUp': 'Đăng ký',
    'auth.signUpOrgTitle': 'Đăng ký doanh nghiệp',
    'auth.signUpOrgDescription': 'Tạo tổ chức và tài khoản quản trị viên.',
    'auth.signUpOrg': 'Đăng ký doanh nghiệp',
    'auth.orgNamePlaceholder': 'Tên tổ chức',
    'auth.taxCodePlaceholder': 'Mã số thuế (tùy chọn)',
    'auth.registerOrgRequired': 'Vui lòng nhập tên tổ chức, họ tên, email và mật khẩu.',
    'auth.registeringOrg': 'Đang đăng ký doanh nghiệp...',
    'auth.switchToOrgSignUp': 'Đăng ký tài khoản doanh nghiệp',
    'auth.switchToCandidateSignUp': 'Đăng ký tài khoản cá nhân',
    ...
    'auth.googleCompletingTitle': 'Đang hoàn tất đăng nhập Google',
    'auth.googleCompletingDescription': 'Vui lòng chờ trong khi hệ thống xác minh mã đăng nhập một lần.',
    'auth.googleCompleting': 'Đang xác minh...',
    'auth.googleErrorTitle': 'Đăng nhập Google thất bại',
    'auth.googleInvalidCode': 'Mã đăng nhập không hợp lệ, đã hết hạn hoặc đã được sử dụng.',
    'auth.googleRemoteError': 'Google đã từ chối hoặc không thể hoàn tất yêu cầu đăng nhập.',
    'auth.googleNoLoginInfo': 'Google không trả về đủ thông tin đăng nhập.',
    'auth.googleAccountSuspended': 'Tài khoản đã bị tạm ngưng. Vui lòng liên hệ bộ phận hỗ trợ.',
    'auth.googleLoginFailed': 'Không thể hoàn tất đăng nhập Google. Vui lòng thử lại.',
    'auth.googleExchangingCode': 'Đang đổi mã và tạo phiên đăng nhập...',
    'auth.googleCodeMissing': 'Không tìm thấy mã đăng nhập Google.',
    'auth.googleExchangeFailed': 'Mã đăng nhập Google không hợp lệ, đã hết hạn hoặc đã được sử dụng.',
    'auth.googleTryAgain': 'Thử đăng nhập Google lại',
    'auth.changePasswordDescription': 'Nhập mật khẩu hiện tại và mật khẩu mới để bảo vệ tài khoản.',
    'auth.oldPassword': 'Mật khẩu hiện tại',
    'auth.oldPasswordRequired': 'Vui lòng nhập mật khẩu hiện tại.',
    'auth.changePasswordFailed': 'Không thể đổi mật khẩu. Vui lòng kiểm tra mật khẩu hiện tại.',
  ...
  en: {
    ...
    'auth.accountBanned': 'This account has been banned. Please contact support.',
    'auth.forgotPassword': 'Forgot password?',
    'auth.signUpTitle': 'Create account',
    'auth.fullNamePlaceholder': 'Full name',
    'auth.password': 'Password',
    'auth.signUp': 'Sign up',
    'auth.signUpOrgTitle': 'Business sign up',
    'auth.signUpOrgDescription': 'Create your organization and administrator account.',
    'auth.signUpOrg': 'Sign up for business',
    'auth.orgNamePlaceholder': 'Organization name',
    'auth.taxCodePlaceholder': 'Tax code (optional)',
    'auth.registerOrgRequired': 'Please enter organization name, full name, email, and password.',
    'auth.registeringOrg': 'Signing up business...',
    'auth.switchToOrgSignUp': 'Sign up for a business account',
    'auth.switchToCandidateSignUp': 'Sign up for a personal account',
    ...
    'auth.googleCompletingTitle': 'Completing Google sign-in',
    'auth.googleCompletingDescription': 'Please wait while we verify the one-time sign-in code.',
    'auth.googleCompleting': 'Verifying...',
    'auth.googleErrorTitle': 'Google sign-in failed',
    'auth.googleInvalidCode': 'The sign-in code is invalid, expired, or has already been used.',
    'auth.googleRemoteError': 'Google declined or could not complete the sign-in request.',
    'auth.googleNoLoginInfo': 'Google did not return enough sign-in information.',
    'auth.googleAccountSuspended': 'This account has been suspended. Please contact support.',
    'auth.googleLoginFailed': 'Google sign-in could not be completed. Please try again.',
    'auth.googleExchangingCode': 'Exchanging the code and creating your session...',
    'auth.googleCodeMissing': 'Google sign-in code is missing.',
    'auth.googleExchangeFailed': 'The Google sign-in code is invalid, expired, or already used.',
    'auth.googleTryAgain': 'Try Google sign-in again',
    'auth.changePasswordDescription': 'Enter your current password and a new password to secure your account.',
    'auth.oldPassword': 'Current password',
    'auth.oldPasswordRequired': 'Please enter your current password.',
    'auth.changePasswordFailed': 'Could not change password. Check your current password.',
