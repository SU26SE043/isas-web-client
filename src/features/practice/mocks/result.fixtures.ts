...
export const MOCK_INTERVIEW_RESULT: InterviewResult = {
  ...
  radarData: [
    { subject: 'Technical', subjectVi: 'Kỹ thuật', A: 78, B: 90, fullMark: 100 },
    { subject: 'Communication', subjectVi: 'Giao tiếp', A: 74, B: 88, fullMark: 100 },
    { subject: 'Problem Solving', subjectVi: 'Giải quyết vấn đề', A: 72, B: 88, fullMark: 100 },
    { subject: 'English', subjectVi: 'Tiếng Anh', A: 66, B: 85, fullMark: 100 },
    { subject: 'Culture Fit', subjectVi: 'Phù hợp văn hóa', A: 84, B: 90, fullMark: 100 },
  ],
  gapAnalysis: [
    {
      id: 'technical-depth',
