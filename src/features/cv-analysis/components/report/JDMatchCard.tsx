...
/**
 * Skill-level comparison against the JD.
 * Deliberately score-free: the AI-generated match percentage was removed because
 * it is not verifiable — only the concrete matched/missing skill lists remain.
 */
