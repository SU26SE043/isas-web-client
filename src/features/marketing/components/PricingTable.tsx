...
import { usePurchasePackage } from '@/features/payment/hooks/usePurchasePackage';
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        {packages.map((pkg) => {
          ...
          const isBuying = activePackageId === pkg.id;
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`w-full text-center disabled:opacity-60 ${popular ? 'btn-primary' : 'btn-secondary'}`}
              >
                {isBuying
                  ? t('payment.checkout.redirecting')
                  : isAuthenticated
                    ? t('pricing.buyPackage')
                    : t('pricing.cta')}
              </button>
            </article>
          );
