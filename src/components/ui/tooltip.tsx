    ...
    <span className="relative inline-flex" onScroll={hide}>
      ...
      {open ? (
        <span
          ...
          role="tooltip"
          className={cn(
            'pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-max max-w-60 -translate-x-1/2 rounded-md bg-black px-2.5 py-1.5 text-xs leading-snug text-white shadow-lg',
            className,
          )}
        >
          {content}
