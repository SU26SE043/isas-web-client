...
const navLinkClassName = ({ isActive }: { isActive: boolean }) =>
  isActive
    ? 'flex items-center gap-3 px-4 py-3 rounded-lg text-sm bg-milk text-pine font-bold shadow-sm'
    : 'flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-white/80 hover:bg-white/10 hover:text-white transition-colors text-left';
